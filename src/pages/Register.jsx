...
const Register = () => {
  return (
    <div class="bg-slate-600 rounded-3xl ">
      <div class="mx-auto flex h-screen max-w-lg flex-col md:max-w-none md:flex-row md:pr-10 ">
        <div class="max-w-md rounded-3xl px-4 py-10 text-white sm:px-10 md:m-6 md:mr-8 bg-[url('src/assets/bg.jpg')] bg-no-repeat	bg-cover bg-right" >
          ...
          <div class="bg-slate-700 rounded-2xl px-4 py-8 opacity-90">
        ...
        <div class="px-4 py-20">
          <h2 class="mb-4 text-4xl font- text-slate-100">Register</h2>
          <a href="#" class="mb-8 block font-bold text-gray-400 ">
            Have an account
          </a>
          <p class="mb-1 font-medium text-gray-200">What is your Role</p>
          <div class="mb-6 flex flex-col gap-y-2 gap-x-4 lg:flex-row">
            <div class="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-3 font-medium text-gray-700">
              ...
              <span class="pointer-events-none z-10 ">Teacher</span>
            </div>
            <div class="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-3 font-medium text-gray-700">
              <input
                class="peer hidden"
              ...
              <div class="peer-checked:border-transparent peer-checked:bg-blue-600 peer-checked:ring-2 absolute left-4 h-5 w-5 rounded-full border-2 border-gray-300 bg-gray-200 ring-blue-600 ring-offset-2"></div>
              <span class="pointer-events-none z-10">Student</span>
            </div>
          </div>
          {/* /* -------------------------------------------------------------------------- */ }
          <p class="mb-1 font-medium text-gray-200">Email</p>
          ...
          {/* /* --------------------------------------------------------------------------  */}
          <p class="mb-1 font-medium text-gray-200">Password</p>
          <div class="mb-4 flex flex-col">
          ...
          <button class="hover:shadow-blue-700/40 w-full rounded-xl bg-gradient-to-r from-slate-500 to-slate-500 px-8 py-3 font-bold text-white transition-all hover:opacity-90 hover:shadow-lg">
            Submit
          </button>
        </div>
      </div>
